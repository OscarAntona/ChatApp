...
import com.oag.chatapp.databinding.ItemIncomingMessageBinding
import com.oag.chatapp.databinding.ItemOutgoingMessageBinding
...
): androidx.recyclerview.widget.ListAdapter<Message, BaseListViewHolder<*>>(DiffUtilCallback)  {
